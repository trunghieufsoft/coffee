...
$(document).ready(function() {
	...
	if(divRequest == 'add')  {
		...
		$("#createOrderForm").unbind('submit').bind('submit', function() {
			...
			// form validation 
			if(orderDate == "") {
				$("#orderDate").after('<p class="text-danger"> Không được để trống </p>');
			...
			if(clientName == "") {
				$("#clientName").after('<p class="text-danger"> Không được để trống </p>');
			...
			if(clientContact == "") {
				$("#clientContact").after('<p class="text-danger"> Không được để trống </p>');
			...
			if(paid == "") {
				$("#paid").after('<p class="text-danger"> Không được để trống </p>');
			...
			if(discount == "") {
				$("#discount").after('<p class="text-danger"> Không được để trống </p>');
			...
			if(paymentType == "") {
				$("#paymentType").after('<p class="text-danger"> Không được để trống </p>');
			...
			if(paymentStatus == "") {
				$("#paymentStatus").after('<p class="text-danger"> Không được để trống </p>');
		    ...
		    if(productName[x].value == ''){	    		    	
		    	$("#"+productNameId+"").after('<p class="text-danger"> Không được để trống </p>');
	   	...
	   	for (var x = 0; x < quantity.length; x++) {       
		    ...
		    if(quantity[x].value == ""){	    	
		    	$("#"+quantityId+"").after('<p class="text-danger"> Không được để trống </p>');
		...
		$("#editOrderForm").unbind('submit').bind('submit', function() {
			...
			// form validation 
			if(orderDate == "") {
				$("#orderDate").after('<p class="text-danger"> Không được bỏ trống </p>');
				$('#orderDate').closest('.form-group').addClass('has-error');
			} else {
				$('#orderDate').closest('.form-group').addClass('has-success');
			} // /else
			...
			if(clientName == "") {
				$("#clientName").after('<p class="text-danger"> Không được bỏ trống </p>');
				$('#clientName').closest('.form-group').addClass('has-error');
			} else {
				$('#clientName').closest('.form-group').addClass('has-success');
			} // /else
			...
			if(clientContact == "") {
				$("#clientContact").after('<p class="text-danger"> Không được bỏ trống </p>');
				$('#clientContact').closest('.form-group').addClass('has-error');
			} else {
				$('#clientContact').closest('.form-group').addClass('has-success');
			} // /else
			...
			if(paid == "") {
				$("#paid").after('<p class="text-danger"> Không được bỏ trống </p>');
				$('#paid').closest('.form-group').addClass('has-error');
			} else {
				$('#paid').closest('.form-group').addClass('has-success');
			} // /else
			...
			if(discount == "") {
				$("#discount").after('<p class="text-danger"> Không được bỏ trống </p>');
				$('#discount').closest('.form-group').addClass('has-error');
			} else {
				$('#discount').closest('.form-group').addClass('has-success');
			} // /else
			...
			if(paymentType == "") {
				$("#paymentType").after('<p class="text-danger"> Không được bỏ trống </p>');
				$('#paymentType').closest('.form-group').addClass('has-error');
			} else {
				$('#paymentType').closest('.form-group').addClass('has-success');
			} // /else
			...
			if(paymentStatus == "") {
				$("#paymentStatus").after('<p class="text-danger"> Không được bỏ trống </p>');
				$('#paymentStatus').closest('.form-group').addClass('has-error');
			} else {
				$('#paymentStatus').closest('.form-group').addClass('has-success');
			} // /else
	   	...
	   	for (var x = 0; x < quantity.length; x++) {       
	 			var quantityId = quantity[x].id;
		    if(quantity[x].value == ''){	    	
		    	$("#"+quantityId+"").after('<p class="text-danger"> Không được bỏ trống!! </p>');
		    	$("#"+quantityId+"").closest('.form-group').addClass('has-error');	    		    		    	
	      } else {      	
		    	$("#"+quantityId+"").closest('.form-group').addClass('has-success');	    		    		    		    	
	      } 
